<template>
  <div class="container">
    ...
    <div class="derecha">
          <div class="titulo-principal">CALENDARIO DE LOS MONTALVO</div>
      <div class="wrap">
        <div>
          <Calendar />        
    ...
    <div class="footer">Idea, dibujos, fotos, código (y básicamente todo) por: Ana Montalvo Isasi</div>
  </div>
</template>
...
.puerta {
  height: 150px;
  width: 150px;
  background-image: url(./images/ventana.png);
